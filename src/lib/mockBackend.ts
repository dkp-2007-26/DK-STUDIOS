...
export const servicesCatalog: Service[] = [
  { id: 'premium-retouching', name: 'Premium Retouching', description: 'Professional skin cleanup, colour correction, and polished portrait enhancement.', base_price: 49, print_price: 0, category: 'retouching', image_url: '/services/premium-retouching.jpg', source_url: null, supplier: null, supplier_label: null, product_details: ['Digital only', 'Portrait cleanup'], product_options: [], is_active: true, sort_order: 1, created_at: '2026-01-01T00:00:00.000Z' },
  { id: 'digital-sketch', name: 'Digital Sketch', description: 'Digital sketch artwork with colour or black and white output options.', base_price: 199, print_price: 0, category: 'sketch', image_url: '/services/digital-sketch.jpg', source_url: null, supplier: null, supplier_label: null, product_details: ['Colour', 'Black and White'], product_options: [{ key: 'sketch_style', label: 'Sketch style', type: 'select', values: ['Colour', 'Black and White'], required: true }], is_active: true, sort_order: 2, created_at: '2026-01-01T00:00:00.000Z' },
  { id: 'custom-sketch', name: 'Custom Sketch', description: 'Tell us what you want; DK STUDIOS creates the sketch and refines it with you.', base_price: 249, print_price: 0, category: 'sketch', image_url: '/services/custom-sketch.jpg', source_url: null, supplier: null, supplier_label: null, product_details: ['Made from your idea', 'Refinement included'], product_options: [{ key: 'sketch_style', label: 'Sketch style', type: 'select', values: ['Colour', 'Black and White'], required: true }], is_active: true, sort_order: 3, created_at: '2026-01-01T00:00:00.000Z' },
  { id: 'poster-making', name: 'Poster Making', description: 'Premium poster layout for events, launches, announcements, and promotions.', base_price: 149, print_price: 79, category: 'design', image_url: '/services/poster-making.jpg', source_url: null, supplier: null, supplier_label: null, product_details: ['Event posters', 'Promotional layouts'], product_options: [], is_active: true, sort_order: 4, created_at: '2026-01-01T00:00:00.000Z' },
];
