          ...
          {services.slice(0, 8).map((service) => {
            ...
            return (
              <button
                ...
                className="group flex min-h-[254px] flex-col rounded-lg border border-stone-200 bg-white p-5 text-left shadow-[0_18px_50px_rgba(52,36,10,0.08)] transition hover:-translate-y-1 hover:border-stone-300"
              >
                ...
                <span className="mt-auto flex items-end justify-between pt-5">
                  <span>
                    <span className="block text-xl font-black text-stone-950">Rs. {service.base_price}</span>
