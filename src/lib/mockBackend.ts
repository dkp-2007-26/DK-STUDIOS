...
export const servicesCatalog: Service[] = [
  { id: '1', name: 'Birthday Photo Editing', description: 'Beautiful birthday collages and photo edits with custom themes', base_price: 199, print_price: 99, category: 'editing', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 1, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '2', name: 'Anniversary Photo Editing', description: 'Romantic anniversary layouts and memory collages', base_price: 249, print_price: 99, category: 'editing', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 2, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '3', name: 'Premium Retouching', description: 'Professional skin retouching, color grading, and enhancement', base_price: 349, print_price: 149, category: 'retouching', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 3, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '4', name: 'Pencil Sketch (B&W)', description: 'Hand-drawn style black & white pencil sketch from your photo', base_price: 299, print_price: 99, category: 'sketch', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 4, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '5', name: 'Color Digital Sketch', description: 'Vibrant color digital sketch with artistic effects', base_price: 399, print_price: 149, category: 'sketch', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 5, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '6', name: 'Poster Making', description: 'Custom poster design for events, promotions, and more', base_price: 149, print_price: 79, category: 'design', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 6, created_at: '2026-01-01T00:00:00.000Z' },
  { id: '7', name: 'Printing (A4 or smaller)', description: 'High-quality print on premium paper up to A4 size', base_price: 79, print_price: 0, category: 'print', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 7, created_at: '2026-01-01T00:00:00.000Z' },
  { id: 'custom', name: 'Custom Design', description: 'Your vision, our craft - fully custom artwork', base_price: 299, print_price: 99, category: 'custom', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: [], is_active: true, sort_order: 8, created_at: '2026-01-01T00:00:00.000Z' },
];
