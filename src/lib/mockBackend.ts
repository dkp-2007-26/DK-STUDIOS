...
export const servicesCatalog: Service[] = [
  { id: '3', name: 'Premium Retouching', description: 'Professional skin retouching, color grading, and enhancement', base_price: 49, print_price: 0, category: 'retouching', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: ['Digital only'], product_options: [], is_active: true, sort_order: 1, created_at: '2026-01-01T00:00:00.000Z' },
  { id: 'digital-sketch', name: 'Digital Sketch', description: 'Digital sketch artwork with colour or black and white output options', base_price: 199, print_price: 0, category: 'sketch', image_url: null, source_url: null, supplier: null, supplier_label: null, product_details: ['Colour', 'Black and White'], product_options: [{ key: 'sketch_style', label: 'Sketch style', type: 'select', values: ['Colour', 'Black and White'], required: true }], is_active: true, sort_order: 2, created_at: '2026-01-01T00:00:00.000Z' },
